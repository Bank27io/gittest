...
class Wmeter extends StatefulWidget {
  @override
  _WmeterState createState() => _WmeterState();
}

class _WmeterState extends State<Wmeter> {
  bool detail = false;
  ...
  LineChartData sampleData1price() {
    return LineChartData(
      ...
      gridData: const FlGridData(horizontalInterval: 1000,
        show: true,
      ),
  ...
  List<LineChartBarData> linesBarData1() {
    return [
      LineChartBarData(
        ...
        dotData: FlDotData( dotColor: Colors.red,
          show: true,
        ),
  ...
  LineChartData sampleData2unit() {
    return LineChartData(
      ...
      gridData: const FlGridData(horizontalInterval: 100,
        show: true,
      ),
      titlesData: FlTitlesData(
        bottomTitles: SideTitles(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:  Text('NAME DEVICE',style: TextStyle(color: Colors.blue[200]),
        ),
      ),
      body: Stack(
        children: <Widget>[
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Container(margin: EdgeInsets.only(top:10),
                      child: LineChart(
                        isShowingMainData ? sampleData1price() : sampleData2unit(),
                        ...
                        children: <Widget>[
                          RaisedButton(
                              ...
                              child: Container(
                                margin: EdgeInsets.all(10),
                                child: Center(
                                    child: Text("แสดงค่าน้ำประปาในแต่ละเดือน",
                                        style: TextStyle(
                                            color: Colors.black,
                                            fontWeight: FontWeight.bold))),
                                height: 40,
